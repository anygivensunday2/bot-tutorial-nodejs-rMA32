...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexAd=/^\/advance/;botRegexMI = /^\/cry joe/; botDEZ = /^\/eat/; botDuck = /^\/duck/;
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("https://media.giphy.com/media/l3q2K5jinAlChoCLS/giphy.gif");
    this.res.end();
  } 
...
this.res.writeHead(200);
postMessage("https://i.groupme.com/169x413.png.b70c24190e7d4723a332f1220894f12f");
this.res.end();
}
...
this.res.writeHead(200);
postMessage("https://daddyleagues.com/ags17");
this.res.end();
}
